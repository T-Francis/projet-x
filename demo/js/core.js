...
$( document ).ready(function() {
	...
	// using a regex so we look for */projetx/demo/ or */projetx/demo/index.html
	// if ( /^http:\/\/([0-9\.]){1,15}\/projetx(\/)?(index\.html)?$/.test(window.location.href) ) {
		// alert("index");
	// 	var urls = ["/projetx/demo/views/inc/navigation/nav.logOff.inc.html","/projetx/demo/views/inc/navigation/footer.inc.html"];
	// } else {
		// alert("not index");
		var urls = ["/projetx/demo/views/inc/navigation/nav.inc.html","/projetx/demo/views/inc/navigation/footer.inc.html"];
	// }
 ...
 * JSON FORMAT { data: [{},{}] }
 * var taskDominique = returnData("/projetx/demo/data/taskDominiqueActive.json");
...
/**
 * [getById description]
 * var projectPokemon = getById("/projetx/demo/data/projectsAll.json", 0);
...
function editProject(id){
	populateInput( getById("/projetx/demo/data/projectsAll.json", id ) );
